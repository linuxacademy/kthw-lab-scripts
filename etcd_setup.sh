...
# Required env vars: INTERNAL_IP, ETCD_NAME, CONTROLLER0_IP, CONTROLLER1_IP
...
ExecStart=/usr/local/bin/etcd \\
  ...
  --initial-cluster controller0=https://${CONTROLLER0_IP}:2380,controller1=https://${CONTROLLER1_IP}:2380 \\
